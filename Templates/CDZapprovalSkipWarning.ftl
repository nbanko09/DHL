...
&trade;</span></font></i></b>
  ...
  <tr>
    ...
    <b>CDZ Request Approval Escalation Warning</b><br>
    <br>
    Dear ${user.displayName}:<br>
    <br>
Please be aware this CDZ Request will be escalated to your manager for approval if it is not acted upon within the next 1 hour.</font>
