...
&trade;</span></font></i></b>
  ...
  <tr>
    ...
    <br>
Your request has been rejected.  Please refer to the reject reason on the request.  Your options are to amend and re-submit or cancel the request</font>
    <font size="2" face="Verdana"><br>
Please click <a href="${baseURL}/filenet/apdocument.do?wobNumber=${document.wobNumber}&amp;ceDocumentId=${document.ceDocumentId}">
here</a> to view and process your request.
		...
		<table>
			...
			<tr>
			<td width="50%"><font size="2" face="Verdana"><b>Customer/Vendor Name:</b></font></td>
