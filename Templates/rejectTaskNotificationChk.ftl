...
&trade;</span></font></i></b>
  ...
  <tr>
    ...
    <br>
    Your check/credit card request has been rejected.  Please refer to the reject reason on the request.  Your options are to amend and re-submit or cancel the request</font>
